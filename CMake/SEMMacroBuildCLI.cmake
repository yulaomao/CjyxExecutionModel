...
macro(SEMMacroBuildCLI)
  ...
  if(NOT DEFINED CjyxExecutionModel_CLI_LIBRARY_WRAPPER_CXX)
    set(LOCAL_SEM_CLI_LIBRARY_WRAPPER_CXX ${CjyxExecutionModel_DEFAULT_CLI_LIBRARY_WRAPPER_CXX})
  else()
    set(LOCAL_SEM_CLI_LIBRARY_WRAPPER_CXX ${CjyxExecutionModel_CLI_LIBRARY_WRAPPER_CXX})
  endif()
  ...
  if(DEFINED CjyxExecutionModel_EXTRA_INCLUDE_DIRECTORIES)
    include_directories(${CjyxExecutionModel_EXTRA_INCLUDE_DIRECTORIES})
  endif()
  ...
  if(NOT DEFINED CjyxExecutionModel_CLI_LIBRARY_LINK_FLAGS)
    set(_cli_library_link_flags ${CjyxExecutionModel_DEFAULT_CLI_LIBRARY_LINK_FLAGS})
  else()
    set(_cli_library_link_flags ${CjyxExecutionModel_CLI_LIBRARY_LINK_FLAGS})
  endif()
  ...
  if(DEFINED CjyxExecutionModel_EXTRA_EXECUTABLE_TARGET_LIBRARIES)
    list(APPEND cli_executable_libraries ${CjyxExecutionModel_EXTRA_EXECUTABLE_TARGET_LIBRARIES})
  endif()
  if(NOT "${DEFAULT_SEM_TARGET_LIBRARIES}" STREQUAL "")
  ...
  if(NOT DEFINED CjyxExecutionModel_CLI_EXECUTABLE_LINK_FLAGS)
    set(_cli_executable_link_flags ${CjyxExecutionModel_DEFAULT_CLI_EXECUTABLE_LINK_FLAGS})
  else()
    set(_cli_executable_link_flags ${CjyxExecutionModel_CLI_EXECUTABLE_LINK_FLAGS})
  endif()
  ...
  foreach(type RUNTIME LIBRARY ARCHIVE)
    if(NOT DEFINED LOCAL_SEM_${type}_OUTPUT_DIRECTORY)
      if(NOT DEFINED CjyxExecutionModel_CLI_${type}_OUTPUT_DIRECTORY)
        set(LOCAL_SEM_${type}_OUTPUT_DIRECTORY ${CjyxExecutionModel_DEFAULT_CLI_${type}_OUTPUT_DIRECTORY})
      else()
        set(LOCAL_SEM_${type}_OUTPUT_DIRECTORY ${CjyxExecutionModel_CLI_${type}_OUTPUT_DIRECTORY})
      endif()
      if(LOCAL_SEM_VERBOSE)
  ...
  if(NOT LOCAL_SEM_NO_INSTALL)
    ...
    foreach(type RUNTIME LIBRARY ARCHIVE)
      if(NOT DEFINED LOCAL_SEM_INSTALL_${type}_DESTINATION)
        if(NOT DEFINED CjyxExecutionModel_CLI_INSTALL_${type}_DESTINATION)
          set(LOCAL_SEM_INSTALL_${type}_DESTINATION ${CjyxExecutionModel_DEFAULT_CLI_INSTALL_${type}_DESTINATION})
        else()
          set(LOCAL_SEM_INSTALL_${type}_DESTINATION ${CjyxExecutionModel_CLI_INSTALL_${type}_DESTINATION})
        endif()
        if(LOCAL_SEM_VERBOSE)
