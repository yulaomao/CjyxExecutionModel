...
#! if CjyxExecutionModel_USE_UTF8 is enabled.
#!
...
if(CjyxExecutionModel_USE_UTF8 AND WIN32)
  add_executable(${ARGN} ${CjyxExecutionModel_CMAKE_DIR}/WindowsApplicationUseUtf8.manifest)
else()
  add_executable(${ARGN})
endif()
